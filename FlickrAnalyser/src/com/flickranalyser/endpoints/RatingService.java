...
public class RatingService {
	...
	public Response addNewRating(@Named("userPrimaryKey") String userPrimaryKey, 
			@Named("clusterPrimaryKey") String clusterPrimaryKey) {
		return PFSaverRating.saveRatingToDatastore(userPrimaryKey, clusterPrimaryKey);
	}
	
	
	@ApiMethod(name="hasUserAlreadyVoted")
	public Response hasUserAlreadyVoted(@Named("userPrimaryKey") String userPrimaryKey, 
			@Named("clusterPrimaryKey") String clusterPrimaryKey) {
