...
public class GoogleAuthHelper {
	...
	public GoogleAuthHelper() {
		this.flow = new GoogleAuthorizationCodeFlow.Builder(HTTP_TRANSPORT, JSON_FACTORY, "1099379908084-erlt14509li8acjpd7m20770t9gi5c0g.apps.googleusercontent.com", "zoQ1ahfrdOIglvRNv210_Yy0",
				(Collection) SCOPE).build();
