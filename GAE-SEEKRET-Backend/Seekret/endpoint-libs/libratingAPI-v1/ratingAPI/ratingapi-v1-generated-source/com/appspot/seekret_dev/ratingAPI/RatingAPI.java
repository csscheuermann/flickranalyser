...
public class RatingAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.18.0-rc of the ratingAPI library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   *
   * This request holds the parameters needed by the ratingAPI server.  After setting any optional
   * parameters, call the {@link AddNewRating#execute()} method to invoke the remote operation.
   *
   * @param clusterPrimaryKey
   * @return the request
   */
  public AddNewRating addNewRating(java.lang.String clusterPrimaryKey) throws java.io.IOException {
    AddNewRating result = new AddNewRating(clusterPrimaryKey);
    initialize(result);
    return result;
  }
  ...
  public class AddNewRating extends RatingAPIRequest<com.appspot.seekret_dev.ratingAPI.model.Response> {
    ...
    private static final String REST_PATH = "addNewRating/{clusterPrimaryKey}";
     ...
     * @since 1.13
     */
    protected AddNewRating(java.lang.String clusterPrimaryKey) {
  ...
  /**
   * Create a request for the method "hasAlreadyDismissed".
   *
   * This request holds the parameters needed by the ratingAPI server.  After setting any optional
   * parameters, call the {@link HasAlreadyDismissed#execute()} method to invoke the remote operation.
   *
   * @param clusterPrimaryKey
   * @return the request
   */
  public HasAlreadyDismissed hasAlreadyDismissed(java.lang.String clusterPrimaryKey) throws java.io.IOException {
    HasAlreadyDismissed result = new HasAlreadyDismissed(clusterPrimaryKey);
    initialize(result);
    return result;
  }

  public class HasAlreadyDismissed extends RatingAPIRequest<com.appspot.seekret_dev.ratingAPI.model.Response> {

    private static final String REST_PATH = "hasAlreadyDismissed/{clusterPrimaryKey}";

    /**
     * Create a request for the method "hasAlreadyDismissed".
     *
     * This request holds the parameters needed by the the ratingAPI server.  After setting any
     * optional parameters, call the {@link HasAlreadyDismissed#execute()} method to invoke the remote
     * operation. <p> {@link HasAlreadyDismissed#initialize(com.google.api.client.googleapis.services.
     ...
     * @since 1.13
     */
    protected HasAlreadyDismissed(java.lang.String clusterPrimaryKey) {
      super(RatingAPI.this, "POST", REST_PATH, null, com.appspot.seekret_dev.ratingAPI.model.Response.class);
      this.clusterPrimaryKey = com.google.api.client.util.Preconditions.checkNotNull(clusterPrimaryKey, "Required parameter clusterPrimaryKey must be specified.");
    }

    @Override
    public HasAlreadyDismissed setAlt(java.lang.String alt) {
      return (HasAlreadyDismissed) super.setAlt(alt);
    }

    @Override
    public HasAlreadyDismissed setFields(java.lang.String fields) {
      return (HasAlreadyDismissed) super.setFields(fields);
    }

    @Override
    public HasAlreadyDismissed setKey(java.lang.String key) {
      return (HasAlreadyDismissed) super.setKey(key);
    }

    @Override
    public HasAlreadyDismissed setOauthToken(java.lang.String oauthToken) {
      return (HasAlreadyDismissed) super.setOauthToken(oauthToken);
    }

    @Override
    public HasAlreadyDismissed setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (HasAlreadyDismissed) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public HasAlreadyDismissed setQuotaUser(java.lang.String quotaUser) {
      return (HasAlreadyDismissed) super.setQuotaUser(quotaUser);
    }

    @Override
    public HasAlreadyDismissed setUserIp(java.lang.String userIp) {
      return (HasAlreadyDismissed) super.setUserIp(userIp);
    }
    ...
    public HasAlreadyDismissed setClusterPrimaryKey(java.lang.String clusterPrimaryKey) {
      this.clusterPrimaryKey = clusterPrimaryKey;
      return this;
    }

    @Override
    public HasAlreadyDismissed set(String parameterName, Object value) {
      return (HasAlreadyDismissed) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "hasAlreadyDismissedOrVoted".
   *
   * This request holds the parameters needed by the ratingAPI server.  After setting any optional
   * parameters, call the {@link HasAlreadyDismissedOrVoted#execute()} method to invoke the remote
   * operation.
   *
   * @param clusterPrimaryKey
   * @return the request
   */
  public HasAlreadyDismissedOrVoted hasAlreadyDismissedOrVoted(java.lang.String clusterPrimaryKey) throws java.io.IOException {
    HasAlreadyDismissedOrVoted result = new HasAlreadyDismissedOrVoted(clusterPrimaryKey);
    initialize(result);
    return result;
  }

  public class HasAlreadyDismissedOrVoted extends RatingAPIRequest<com.appspot.seekret_dev.ratingAPI.model.Response> {

    private static final String REST_PATH = "hasAlreadyDismissedOrVoted/{clusterPrimaryKey}";

    /**
     * Create a request for the method "hasAlreadyDismissedOrVoted".
     *
     * This request holds the parameters needed by the the ratingAPI server.  After setting any
     * optional parameters, call the {@link HasAlreadyDismissedOrVoted#execute()} method to invoke the
     * remote operation. <p> {@link HasAlreadyDismissedOrVoted#initialize(com.google.api.client.google
     ...
     * @since 1.13
     */
    protected HasAlreadyDismissedOrVoted(java.lang.String clusterPrimaryKey) {
      super(RatingAPI.this, "POST", REST_PATH, null, com.appspot.seekret_dev.ratingAPI.model.Response.class);
      this.clusterPrimaryKey = com.google.api.client.util.Preconditions.checkNotNull(clusterPrimaryKey, "Required parameter clusterPrimaryKey must be specified.");
    }

    @Override
    public HasAlreadyDismissedOrVoted setAlt(java.lang.String alt) {
      return (HasAlreadyDismissedOrVoted) super.setAlt(alt);
    }

    @Override
    public HasAlreadyDismissedOrVoted setFields(java.lang.String fields) {
      return (HasAlreadyDismissedOrVoted) super.setFields(fields);
    }

    @Override
    public HasAlreadyDismissedOrVoted setKey(java.lang.String key) {
      return (HasAlreadyDismissedOrVoted) super.setKey(key);
    }

    @Override
    public HasAlreadyDismissedOrVoted setOauthToken(java.lang.String oauthToken) {
      return (HasAlreadyDismissedOrVoted) super.setOauthToken(oauthToken);
    }

    @Override
    public HasAlreadyDismissedOrVoted setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (HasAlreadyDismissedOrVoted) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public HasAlreadyDismissedOrVoted setQuotaUser(java.lang.String quotaUser) {
      return (HasAlreadyDismissedOrVoted) super.setQuotaUser(quotaUser);
    }

    @Override
    public HasAlreadyDismissedOrVoted setUserIp(java.lang.String userIp) {
      return (HasAlreadyDismissedOrVoted) super.setUserIp(userIp);
    }
    ...
    public HasAlreadyDismissedOrVoted setClusterPrimaryKey(java.lang.String clusterPrimaryKey) {
      this.clusterPrimaryKey = clusterPrimaryKey;
      return this;
    }

    @Override
    public HasAlreadyDismissedOrVoted set(String parameterName, Object value) {
      return (HasAlreadyDismissedOrVoted) super.set(parameterName, value);
    }
  }
   ...
   * @return the request
   */
  public HasUserAlreadyVoted hasUserAlreadyVoted(java.lang.String clusterPrimaryKey) throws java.io.IOException {
    HasUserAlreadyVoted result = new HasUserAlreadyVoted(clusterPrimaryKey);
    initialize(result);
    return result;
  }
  ...
  public class HasUserAlreadyVoted extends RatingAPIRequest<com.appspot.seekret_dev.ratingAPI.model.Response> {
    ...
    private static final String REST_PATH = "hasUserAlreadyVoted/{clusterPrimaryKey}";
     ...
     * @since 1.13
     */
    protected HasUserAlreadyVoted(java.lang.String clusterPrimaryKey) {
      super(RatingAPI.this, "POST", REST_PATH, null, com.appspot.seekret_dev.ratingAPI.model.Response.class);
      this.clusterPrimaryKey = com.google.api.client.util.Preconditions.checkNotNull(clusterPrimaryKey, "Required parameter clusterPrimaryKey must be specified.");
    }
