...
public class SpotToCrawl implements Serializable{
	...
	@Persistent 
	private boolean onlyExcludedPictures;
	...
	public SpotToCrawl(double latitude, double longitude, String name, String description, double clusterRadiusInKm, double spotRadiusInKm, Key dataStoreKey, int maxPOINumberPerCluster, int maxViewNumberPerCluster, boolean onlyExcludedPictures) {
	...
	public SpotToCrawl(Spot spot, boolean onlyExcludedPictures) {
	...
	public boolean isOnlyExcludedPictures() {
		return onlyExcludedPictures;
	}

	public void setOnlyExcludedPictures(boolean onlyExcludedPictures) {
		this.onlyExcludedPictures = onlyExcludedPictures;
	}	
